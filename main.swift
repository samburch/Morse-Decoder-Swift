...
letterToMorse = ["a" : ".-", "b" : "-...", "c" : "-.-.", "d" : "-..", "e" : ".", "f" : "..-.", "g" : "--.", "h" : "....", "i" : "..", "j" : ".---", "k" : "-.-", "l" : ".-..", "m" : "--", "n" : "-.", "o" : "---", "p" : ".--.", "q" : "--.-", "r" : ".-.", "s" : "...", "t" : "-", "u" : "..-", "v" : "...-", "w" : ".--", "x" : "-..-", "y" : "-.--", "z" : "--.."]

// Encoding a Message

// String to store morse code
var morseText = ""
...
morseCodeArray.append(currMorse)
// Print out the morse code array now that we know waht it is
print("This is the full MorseCodeArray \(morseCodeArray)")
...
for (letter, char) in letterToMorse {
  morseToLetter[char] = letter
}
print("These are all the converted letters: \(morseToLetter)")
